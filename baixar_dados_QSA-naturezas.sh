...
rm -f ./tmp/Natureza*
rm -rfd ./tmp/extracted_files/nat/ 
...
if ! [ -d ./tmp/extracted_files/nat/ ]; then
    mkdir ./tmp/extracted_files/nat/
fi


cd ./tmp/
MES_ATUAL="2025-02"
# baixar arquivo Naturezas.zip e extrair o conteúdo
FILENAME="Naturezas.zip"
...
unzip $FILENAME -d extracted_files/nat/

echo "======> Extraiu zip na pasta extracted_files/nat/"

echo "Conteúdo final da pasta extracted_files/nat/"
ls extracted_files/nat/
